...
_S: dict[tuple[str, str], str] = {
    ...
    ("ro", "manager_ask_phone"): "Numărul dvs. de telefon? (ex: 068 123 456 / +373 68 123 456)",
    ("en", "manager_ask_phone"): "Your phone number? (e.g. 068 123 456 / +373 68 123 456)",
    ("ru", "manager_ask_phone"): "Ваш номер телефона? (например: 068 123 456 / +373 68 123 456)",
    ("ro", "manager_phone_invalid"): "Nu am recunoscut un număr valid. Vă rog să îl scrieți din nou (ex: 068 123 456 / +373 68 123 456).",
    ("en", "manager_phone_invalid"): "I didn't recognise a valid number. Please enter it again (e.g. 068 123 456 / +373 68 123 456).",
    ("ru", "manager_phone_invalid"): "Не удалось распознать номер. Пожалуйста, введите снова (например: 068 123 456 / +373 68 123 456).",
